...
from model import R2LMultiHeadAttention
...
def evaluate():
    ...
    try:
        model = R2LMultiHeadAttention(d_model=128, num_heads=4).to(device)
        model.eval()
    ...
    print(f"Checking Task 2: Right-to-Left Attention Implementation...")
    print("-" * 60)
